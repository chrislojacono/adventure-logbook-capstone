...
export default class SearchBox extends Component {
  ...
  handleSubmit2 = (e) => {
    ...
    getRoutes(lattitude, longitude, maxDist, maxResults, minDiff, maxDiff).then((response) => {
  ...
  render() {
    ...
    return (
      <>
      {success
        && <Alert variant={'success'}>Routes found!</Alert>}
      {lattitude === '' ? <Form onSubmit={this.handleSubmit}>
